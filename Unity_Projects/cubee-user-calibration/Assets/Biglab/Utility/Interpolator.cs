...
namespace Biglab
{
    ...
    // Author: Christopher Chamberlain - 2017
    {
        ...
        /// </summary>
        public float Current { get { return Mathf.Min( Time.time - StartTime, Duration ); } }

        /// <summary>
        /// Gets the interpolation factor ( percent of duration ).
        /// </summary>
        public float Factor { get { return Current / Duration; } }

        /// <summary>
        /// Gets the interpolation factor ( percent of duration ).
        /// </summary>
        public float DeltaFactor { get { return Time.deltaTime / Duration; } }
        ...
        {
            return new Interpolator( Time.time, duration, clamped );
        }
        ...
        {
            return ( rate / distance ) * ( Time.deltaTime * duration );
        }
